...
（1）本题的试飞次数是指记录鸟儿飞向窗子的次数加上最后飞离房间的一次，其分布律为(参见第 4 题(1))
...
\paragraph{\color{fblue}解}
以 $X$ 表示此人外出时电话铃响的次数，则 $X \sim \pi(2t)$，其中 $t$ 表示外出的总时间，即 $X$ 的分布律为 $P\{X=k\} = \frac{(2t)^k \mathrm{e}^{-2t}}{k!}, k=0,1,2,\cdots$
...
\[ P\{X \leqslant 10\} \approx \sum_{k=0}^{10} \frac{7.5^k \mathrm{e}^{-7.5}}{k!} \stackrel{\text{查表}}{=} \ans{0.862\,2}. \]
