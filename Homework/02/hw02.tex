...
\begin{align*}
    \Prob(A) &= \Prob(A_1) + \Prob(\comp{A_1}A_2) + \Prob(\comp{A_1}\comp{A_2}A_3) \\
             &= \frac{1}{10} + \frac{1}{10} + \frac{1}{10} = \ans{\frac{3}{10}}.
\end{align*}
当已知最后一位数是奇数时，所求概率为
\[ p = \frac{1}{5} + \frac{1}{5} + \frac{1}{5} = \ans{\frac{3}{5}}. \]
...
\begin{align*}
    \Prob(A) &= 1 - \Prob\{\text{拨号三次都接不通}\} = 1 - \Prob(\comp{A_1}\comp{A_2}\comp{A_3}) \\
             ...
             &= 1 - \frac{7}{8} \times \frac{8}{9} \times \frac{9}{10} = \ans{\frac{3}{10}}.
\end{align*}
当已知最后一位是奇数时，所求概率为
\[ p = 1 - \frac{2}{3} \times \frac{3}{4} \times \frac{4}{5} = \ans{\frac{3}{5}}. \]
...
所以
\[ \Prob(W) = \frac{7}{11} \times \frac{1}{6} + \frac{6}{11} \times \frac{10}{18} + \frac{5}{11} \times \frac{5}{18} = \ans{\frac{53}{99}}. \]
...
\[ A = SA = (B \cup \comp{B})A = BA \cup \comp{B}A, \quad (BA)(\comp{B}A) = \varnothing, \]
得
\[ \Prob(A) = \Prob(A|B)\Prob(B) + \Prob(A|\comp{B})\Prob(\comp{B}) = \frac{4}{9} \times \frac{2}{11} + \frac{5}{9} \times \frac{9}{11} = \ans{\frac{53}{99}}. \]
...
\begin{align*}
    \Prob(A_1 | A_2) &= \frac{\Prob(A_1 A_2)}{\Prob(A_2)} \\
                     ...
                     &= \frac{p \cdot p}{p \cdot p + \frac{p}{2}(1-p)} = \ans{\frac{2p}{p+1}}.
\end{align*}
