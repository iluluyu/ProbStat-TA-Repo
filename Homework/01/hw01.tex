...
所求概率为 $\Prob(A \cup B \cup C) = \ans{5/8}$.

（2）
\begin{align*}
    \Prob(A \cup B) &= \Prob(A)+\Prob(B)-\Prob(AB) = \frac{1}{2}+\frac{1}{3}-\frac{1}{10} = \ans{\frac{11}{15}}.\\
    \Prob(\comp{A}\comp{B}) &= \Prob(\comp{A \cup B}) = 1-\Prob(A \cup B) = \ans{\frac{4}{15}}.\\
    \Prob(A \cup B \cup C) &= \Prob(A)+\Prob(B)+\Prob(C)-\Prob(AB)-\Prob(AC)-\Prob(BC)+\Prob(ABC) \\
    &= \frac{1}{2}+\frac{1}{3}+\frac{1}{5}-\frac{1}{10}-\frac{1}{15}-\frac{1}{20}+\frac{1}{30} = \frac{51}{60} = \ans{\frac{17}{20}}.\\
    \Prob(\comp{A}\comp{B}\comp{C}) &= \Prob(\comp{A \cup B \cup C}) = 1-\Prob(A \cup B \cup C) = \ans{\frac{3}{20}}.\\
    ...
    &= \frac{4}{15}-\frac{3}{20} = \frac{16-9}{60} = \ans{\frac{7}{60}}.
\end{align*}
记 $p=\Prob(\comp{A}\comp{B} \cup C)$，由加法公式
\[ p = \Prob(\comp{A}\comp{B})+\Prob(C)-\Prob(\comp{A}\comp{B}C) = \frac{4}{15}+\frac{1}{5}-\frac{7}{60} = \ans{\frac{7}{20}}. \]

（3）(i) $\Prob(A\comp{B}) = \Prob(A(S-B)) = \Prob(A-AB) = \Prob(A)-\Prob(AB) = \ans{1/2}$. \\
(ii) $\Prob(A\comp{B}) = \Prob(A(S-B)) = \Prob(A-AB) = \Prob(A)-\Prob(AB) = 1/2-1/8 = \ans{3/8}$.
...
\[ \Prob(A) = N(A)/N(S) = \binom{5}{2} \Big/ \binom{10}{3} = \ans{\frac{1}{12}}. \]

（2）同理，$N(B)=\binom{4}{2}$，故
\[ \Prob(B) = N(B)/N(S) = \binom{4}{2} \Big/ \binom{10}{3} = \ans{\frac{1}{20}}. \]
...
故
\[ \Prob(A) = N(A)/N(S) = \ans{\binom{400}{90}\binom{1100}{110} \Big/ \binom{1500}{200}}. \]
...
\begin{align*}
    ...
    &= \ans{1-\left[ \binom{1100}{200} + \binom{400}{1}\binom{1100}{199} \right] \Big/ \binom{1500}{200}}.
\end{align*}
